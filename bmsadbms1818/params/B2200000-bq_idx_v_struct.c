...
/* 
8 pin CAN ADM3050
08/28/23 Heater FET not turning on. DUMP2 OK. Did not check DUMP. Resoldered
  IC1 gates
*/
...
#define EighteenPositionBox
  #define EighteenCellsInEighteenBox
   ...
   p->bmsaux[BMSAUX_6_CUR_SENSE].coef[0] = 27639.0f;
   p->bmsaux[BMSAUX_6_CUR_SENSE].coef[1] = 4.43878E-02f;
