/******************************************************************************
* File Name          : B01600000-bq_idx_v_struct.c
* Date First Issued  : 03/15/2023
* Board              : bmsadbms1818
* Description        : Load BQ parameter struct: B1600000 ADBMS1818 board #7
*******************************************************************************/
/* 
16 pin CAN ISO1042
9/14/23 ship gsm
...
//   p->adc_hb       = 64;     // Number of ticks for heartbeat ADC readout
   ...
   p->dcdc_calv = 70.1; // Module voltage used in following settings (e.g. 57.6v)   
 
// 09/13/23: 65.5 ma with the following settings
