/******************************************************************************
* File Name          : B01A00000-bq_idx_v_struct.c
* Date First Issued  : 03/15/2023
* Board              : bmsadbms1818
* Description        : Load BQ parameter struct: B1A00000 ADBMS1818 board #9
*******************************************************************************/
/* 03/16/23
...
//   p->adc_hb       = 64;     // Number of ticks for heartbeat ADC readout
   ...
   p->dcdc_calv = 62.3; // Module voltage used in following settings (e.g. 57.6v)   
 
// 09/14/23: 62.8 ma with the following settings
