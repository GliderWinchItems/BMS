/******************************************************************************
* File Name          : B01C00000-bq_idx_v_struct.c
* Date First Issued  : 03/15/2023
* Board              : bmsadbms1818
* Description        : Load BQ parameter struct: B1C00000 ADBMS1818 board #10
*******************************************************************************/
/* 
8 pin CAN ADM3050
03/16/23 Gave all 65535. 5v to 1818 pin open. Cells 1 - 9 also open.
  Hand iron resoldered.
9/14/23 ship gsm
...
// 09/14/23: 71.5 ma with the following settings
   ...
   p->cellv_max2_inc =  100; // Increment added to cellv_max for external charging   
