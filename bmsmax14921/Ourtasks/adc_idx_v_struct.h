...
#define ADCBMSMAX (16+3+1)   // Number of MAX14921 (cells+thermistors+tos)
...
// LC = Local (sram) Copy of parameters
 struct ADCLC
 {
	...
	struct ADCCALABS cabsbms[ADCBMSMAX];    // BMS Absolute readings
	struct ADCCALABS cabsadc[ADCDIRECTMAX]; // ADC Absolute readings (*)
 };
