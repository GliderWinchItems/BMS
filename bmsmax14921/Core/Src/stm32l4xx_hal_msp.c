...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC5     ------> ADC1_IN14
    */
    GPIO_InitStruct.Pin = FET_CUR_RC_Pin|FET_CUR_A2_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC1_IN14
    */
    HAL_GPIO_DeInit(GPIOC, FET_CUR_RC_Pin|FET_CUR_A2_Pin|Therm_spare1_Pin|Therm_spare2_Pin);
...
void HAL_COMP_MspInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspInit 0 */
    ...
    PB2     ------> COMP1_INP
    PA11     ------> TIM1_BKIN2_COMP1
    */
    GPIO_InitStruct.Pin = HV_div2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(HV_div2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP1_MspDeInit 0 */
    ...
    PA11     ------> TIM1_BKIN2_COMP1
    */
    HAL_GPIO_DeInit(HV_div2_GPIO_Port, HV_div2_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = SPI1_NSS__CS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(SPI1_NSS__CS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(SPI1_NSS__CS_GPIO_Port, SPI1_NSS__CS_Pin);
