...
void DMA1_Channel2_IRQHandler(void)
{
  ...
  adcspi_spidmarx_IRQHandler(&hdma_spi1_rx);
  return;
...
void DMA1_Channel3_IRQHandler(void)
{
  ...
  adcspi_spidmatx_IRQHandler(&hdma_spi1_tx);
  return;
