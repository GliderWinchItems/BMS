...
#define ADC1IDX_ADCSCANSIZE   8 // Number ADC channels read (includes Vref an Vtemp)
...
#define ADC1IDX_PA3_OPA_OUT   0   // IN8  - FET current sense R amplified
#define ADC1IDX_PA4_DC_DC     1   // IN9  - DC-DC (+15v) divider
#define ADC1IDX_PA7_HV_DIV    2   // IN12 - High voltage divider
#define ADC1IDX_PC1_FET_CUR   3   // IN2  - FET current sense R via RC filter
#define ADC1IDX_PC4_THERMSP1  4   // IN13 - Thermistor Spare #1
#define ADC1IDX_PC5_THERMSP2  5   // IN14 - Thermistor Spare #2
#define ADC1IDX_INTERNALTEMP  6   // IN17 - Internal temperature sensor
#define ADC1IDX_INTERNALVREF  7   // IN18 - Internal voltage reference
